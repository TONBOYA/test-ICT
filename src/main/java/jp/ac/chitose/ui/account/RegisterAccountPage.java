...
//public class RegisterAccountPage extends ParentPageWithoutLogin {
...
public class RegisterAccountPage extends ParentPage {
	...
	public RegisterAccountPage(){
		...
		IModel<RegisterAccountBean> model = new CompoundPropertyModel<>(new RegisterAccountBean());
		...
		val form = new Form<RegisterAccountBean>("form",model){
			private static final long serialVersionUID = -1037503508938681238L;
