...
public class PracticeEditPage extends ParentPage {
	...
	public PracticeEditPage(TreeBean parent, IModel<PracticeRegisterBean> practiceModel) {
...
//				});
				...
				if (!(inputError)) {
					if (practiceModel.getObject().getName().equals(beforeName)) {
						...
						setResponsePage(new PracticeEditPage2(parent, practiceModel));
					} else {
